...
Tester.run(
  "SegmentCollidesWithStaticShape",
  [
    [
      ...
      () => {
        ...
        for (let i: number = -0.5; i < 1.5; i += 0.1) {
          Assertions.assertEquals(
            TestGTSegmentCollidesWithStaticShape.test_move_segment_skids_off_corner(
              { x: -2, y: 1 },
              i,
              seg
            ),
    ...
    [
      ...
      () => {
        ...
        Assertions.assertEquals(
          TestGTSegmentCollidesWithStaticShape.test_move_segment_starts_inside_edge(
            p1,
            seg
          ),
          false
