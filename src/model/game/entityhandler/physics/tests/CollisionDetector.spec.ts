...
const make_detector_and_collidables = (
...
const make_collidable = (
  args: ConstructorParameters<typeof Shape>,
  tree: CollidableShapesQuadTree
) => {
...
Tester.run(
  ...
  [
    [
      ...
      () => {
        const detector = make_detector_and_collidables([
          [Rect.to_vertices({ w: 2, h: 2 }), { x: 4, y: 4 }],
        ]);
