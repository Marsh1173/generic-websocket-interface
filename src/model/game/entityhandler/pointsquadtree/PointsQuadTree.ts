...
import { GlobalRect, Rect } from "../../../common/math/geometry/Rect";
import { QuadTree } from "../../../common/quadtree/QuadTree";
import { Entity } from "../../entitymodel/entity/Entity";
import { PointsQuadTreeNode } from "./PointsQuadTreeNode";

export class PointsQuadTree<EntityType extends Entity> extends QuadTree<EntityType, PointsQuadTreeNode<EntityType>> {
