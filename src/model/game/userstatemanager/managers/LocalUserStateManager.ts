...
export class LocalUserStateManager extends UserStateManager {
  ...
  constructor(protected readonly game_system: LocalGameSystem, initial_state_data: UserStateData) {
    super(game_system, initial_state_data);
  }

  protected get_player_state(data: PlayerStateData, goblin: Goblin): LocalPlayerState {
