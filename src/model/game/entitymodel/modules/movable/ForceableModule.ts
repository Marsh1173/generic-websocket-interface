...
export interface ForceableModuleData extends MovableModuleData {}

export interface IForceableModule extends IMovableModule {
  /**
...
export interface HasForceableModule extends HasMovableModule {
  readonly movable_module: IForceableModule;
}

export class ForceableModule extends MovableModule implements IForceableModule {
  /**
   * [force, cap]
   */
  ...
  constructor(
    observable: MovableObservable,
    entity: Entity & HasForceableModule,
    data: ForceableModuleData,
    options: {
      friction_const?: number;
    }
  ) {
    super(observable, entity, data);
